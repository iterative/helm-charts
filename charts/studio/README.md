...
![Version: 0.18.115](https://img.shields.io/badge/Version-0.18.115-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.212.0](https://img.shields.io/badge/AppVersion-v2.212.0-informational?style=flat-square)
...
| vector-agent.rbac | object | `{"extraRules":[{"apiGroups":[""],"resources":["nodes/metrics","nodes/stats"],"verbs":["get"]}]}` | Vector Agent ClusterRole configuration |
...
| vector-aggregator.rbac | object | `{"extraRules":[{"apiGroups":[""],"resources":["events"],"verbs":["get","list"]}]}` | Vector Aggregator ClusterRole configuration |
