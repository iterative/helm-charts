...
| studioDatachainWorkerJobTemplate.envFromSecret | string | `""` | The name of an existing Secret that contains sensitive environment variables passed to DataChain worker Job pods. |
